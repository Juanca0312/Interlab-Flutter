        ...
        child: SingleChildScrollView(
          child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'These terms and conditions outline the rules and regulations for the use of Interlabs Website, located at interlabapi.herokuapp.com.',
                ),
                Text('By accessing this website we assume you accept these terms and conditions. Do not continue to use Interlab if you do not agree to take all of the terms and conditions stated on this page.'),
                ...
                Text('We employ the use of cookies. By accessing Interlab, you agreed to use cookies in agreement with the Interlabs Privacy Policy.'),
                ...
                Text('Unless otherwise stated, Interlab and/or its licensors own the intellectual property rights for all material on Interlab. All intellectual property rights are reserved. You may access this from Interlab for your own personal use subjected to restrictions set in these terms and conditions.'),
                Text('You must not:'),
                Text('°Republish material from Interlab'),
                Text('°Sell, rent or sub-license material from Interlab'),
                Text('°Reproduce, duplicate or copy material from Interlab'),
                Text('°Redistribute content from Interlab'),
                Text('This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the Terms And Conditions Generator.'),
                Text('Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Interlab does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Interlab,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Interlab shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.'),
                Text('Interlab reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.'),
                ...
                Text('You hereby grant Interlab a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.'),
                SizedBox(height: 10,),
                ...
                Text('*accounting, law and consulting firms'),
                Text('*educational institutions and trade associations.'),
                Text('We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Interlab; and (d) the link is in the context of general resource information.'),
                Text('These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party’s site.'),
                Text('If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Interlab. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.'),
                Text('Approved organizations may hyperlink to our Website as follows:'),
                Text('*By use of our corporate name'),
                Text('*By use of the uniform resource locator being linked'),
                ...
                Text('No use of Interlabs logo or other artwork will be allowed for linking absent a trademark license agreement.'),
                SizedBox(height: 10,),
                Text("Iframes",
                  style: TextStyle(
                    color: Colors.black,
                ...
                Text('*limit any of our or your liabilities in any way that is not permitted under applicable law'),
